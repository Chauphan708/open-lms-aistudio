...
export const ParentLinkPrint: React.FC<ParentLinkPrintProps> = ({ data, onBack }) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center bg-gray-50 overflow-y-auto w-full h-full p-4 md:p-8 relative">
      
      {/* Nút điều khiển không hiển thị khi in */}
      <div className="absolute top-4 left-4 right-4 flex justify-between items-center z-10 print:hidden hide-on-print w-[calc(100%-2rem)] max-w-2xl mx-auto">
        <button 
          onClick={onBack}
      ...
      {/* Phiếu In Layout */}
      <div className="w-full max-w-2xl mt-16 print:mt-0 bg-white border border-gray-300 shadow-lg print:shadow-none print:border-none p-8 md:p-12 font-sans relative">
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 border border-gray-200 p-6 rounded-xl flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
               ...
               <p className="text-gray-600 font-medium">Lớp: {data.className}</p>
            </div>
          ...
          <div className="pt-6">
             ...
             <ul className="space-y-3 font-medium text-gray-700 pl-10 list-disc">
               <li>Truy cập địa chỉ mạng nội bộ hoặc trang web trường học trên điện thoại/máy tính có hỗ trợ OpenLMS.</li>
               <li>Đi đến đường dẫn: <b>http://your-domain/parent/login</b> (Hoặc chọn nút Cổng Phụ Huynh trên phần đăng nhập).</li>
